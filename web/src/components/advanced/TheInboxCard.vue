  ...
  >
    ...
    <div class="flex items-center justify-between">
      <div class="flex justify-start gap-2 items-center h-auto font-bold text-2xl">
        <System class="w-4 h-4" />
      </div>
      <div
        class="text-[var(--text-color-next-300)] text-xs font-mono bg-[var(--bg-color-next-100)] px-2 py-0.5 rounded-full"
      >
        {{ props.inbox.type }}
      </div>
    </div>
    ...
    <!-- Time & Source -->
    <div
      class="flex justify-between items-center mt-2 pt-2 border-t border-dashed border-[var(--border-color)]"
    >
