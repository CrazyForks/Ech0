...
func setupUserRoutes(appRouterGroup *AppRouterGroup, h *di.Handlers) {
	...
	appRouterGroup.PublicRouterGroup.POST("/passkey/login/finish", h.UserHandler.PasskeyLoginFinish())
	...
	appRouterGroup.AuthRouterGroup.POST("/passkey/register/begin", h.UserHandler.PasskeyRegisterBegin())
	appRouterGroup.AuthRouterGroup.POST("/passkey/register/finish", h.UserHandler.PasskeyRegisterFinish())
